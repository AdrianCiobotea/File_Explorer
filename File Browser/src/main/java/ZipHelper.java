...
public class ZipHelper {
    ...
    public static void zipDirectory(File[] dir, String zipDirName) {
        try {
            FileOutputStream fos = new FileOutputStream(dir[0].getParent() + File.separator + zipDirName);
    ...
    public static void zipSingleFile(File file, String zipFileName) {
        try {
            //create ZipOutputStream to write to the zip file
            FileOutputStream fos = new FileOutputStream(file.getParent() + File.separator + zipFileName);
            ZipOutputStream zos = new ZipOutputStream(fos);
